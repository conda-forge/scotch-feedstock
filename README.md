...
<table><tr>
    ...
    <td>
      <a href="https://app.travis-ci.com/conda-forge/scotch-feedstock">
        <img alt="linux" src="https://img.shields.io/travis/com/conda-forge/scotch-feedstock/main.svg?label=Linux">
      </a>
    </td>
  </tr>
...
Once the `conda-forge` channel has been enabled, `ptscotch, scotch` can be installed with `conda`:
...
```
mamba install ptscotch scotch
```

It is possible to list all of the versions of `ptscotch` available on your platform with `conda`:
...
```
mamba search ptscotch --channel conda-forge
```
...
mamba repoquery search ptscotch --channel conda-forge

# List packages depending on `ptscotch`:
mamba repoquery whoneeds ptscotch --channel conda-forge

# List dependencies of `ptscotch`:
mamba repoquery depends ptscotch --channel conda-forge
```
